//Library Path: "/System/Library/Frameworks/PCSC.framework/Versions/Current/PCSC"
...
class MacOSBindings extends PcscBindings {
  @override
  void Function(SendPort) get isolateEntryPoint => _linuxIsolateEntry;

  @override
  PcscCommandFactory createCommandFactory() => LinuxCommandFactory();
}

// --- Linux Context ---

class LinuxPcscContext extends PcscContext {
  ...
  LinuxPcscContext(this.winscard, this.scardT0Pci, this.scardT1Pci);
}

// --- Linux Isolate Entry ---

void _linuxIsolateEntry(SendPort sendPort) {
  final receivePort = ReceivePort();
  sendPort.send(receivePort.sendPort);

  final pcsc = ffi.DynamicLibrary.open('/System/Library/Frameworks/PCSC.framework/Versions/Current/PCSC');
  ...
  final context = LinuxPcscContext(winscard, scardT0Pci, scardT1Pci);
...
// --- Linux Commands (private, platform-specific) ---
