...
class WinscardLinux {
  ...
  WinscardLinux(ffi.DynamicLibrary dynamicLibrary)
    : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  WinscardLinux.fromLookup(
...
const int SCARD_E_UNKNOWN_RES_MSG = 2148532267;
...
const String PCSCLITE_VERSION_NUMBER = '2.0.3';
